...
export const getRoleHomePage = (role: UserRole): string => {
  switch (role) {
    ...
    default:
      return APP_PAGES.dashboard.link;
  }
};
 ...
 */
export const getRedirectUrl = (user: { role: UserRole; isOnBoarded?: boolean }): string => {
...
export const hasRouteAccess = (role: UserRole, route: string): boolean => {
  const roleRoutePatterns = {
    [UserRole.Owner]: ['/manager', '/dashboard', '/profile', '/settings', '/notifications'],
    [UserRole.Manager]: ['/manager', '/dashboard', '/profile', '/settings', '/notifications'],
    [UserRole.Coach]: ['/coach', '/dashboard', '/profile', '/settings', '/notifications'],
    [UserRole.Member]: ['/member', '/dashboard', '/profile', '/settings', '/notifications'],
    [UserRole.Staff]: ['/staff', '/dashboard', '/profile', '/settings', '/notifications'],
  };
 ...
 */
export const handleRoleBasedRedirect = (user: { role: UserRole; isOnBoarded?: boolean }): void => {
