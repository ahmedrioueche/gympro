  ...
  return (
    <div className="flex gap-3">
      ...
      <button
        ...
        className="flex-1 px-6 py-3 rounded-xl font-bold text-white bg-primary hover:bg-primary/80 ring-1 ring-blue-500/30 transition-all duration-300 shadow-sm hover:shadow-md hover:shadow-xl flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isPending ? (
