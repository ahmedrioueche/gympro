  ...
  return (
    <>
      ...
      <div
        className={`${
          isMobile
            ? "fixed left-2 right-2 top-[60px] z-[100]"
            : "absolute top-full left-0 mt-3 w-[420px] z-50"
        } bg-background/95 backdrop-blur-2xl rounded-3xl shadow-2xl overflow-hidden border border-white/10 dark:border-white/5`}
        style={{
