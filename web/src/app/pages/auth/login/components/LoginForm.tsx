...
import { Loader, Lock, Mail, Phone } from "lucide-react";
  ...
  return (
    <form className="mt-8 space-y-6" onSubmit={handleLogin}>
      ...
      <button
        ...
        className="w-full flex items-center justify-center px-4 py-3 border border-border rounded-xl bg-surface hover:bg-border text-text-primary font-medium transition-all duration-200 transform cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isGoogleLoading ? (
