...
const AccessLogsPage: React.FC = () => {
  ...
  // Debug logging
  useEffect(() => {
    console.log("AccessLogsPage - Current Gym ID:", currentGym?._id);
    console.log("AccessLogsPage - Logs Response:", logsRes);
    console.log("AccessLogsPage - Is Loading:", isLoadingLogs);
  }, [currentGym?._id, logsRes, isLoadingLogs]);
