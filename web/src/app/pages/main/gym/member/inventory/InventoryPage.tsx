...
import { MemberEquipmentCard } from "./components/MemberEquipmentCard";
import { MemberInventoryControls } from "./components/MemberInventoryControls";
import { useMemberInventory } from "./hooks/useMemberInventory";
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <PageHeader
        ...
        subtitle={t("inventory.memberSubtitle", {
          defaultValue:
            "Explore the equipment and machines available at this gym",
        })}
      />

      <MemberInventoryControls
      ...
      {isLoading ? (
        ...
        <NoData
          ...
          description={t("inventory.empty.memberMessage", {
            defaultValue: "This gym hasn't added any equipment yet.",
          })}
        />
      ) : isNoResults ? (
        <NoData
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
            {items.map((item) => (
              <MemberEquipmentCard key={item._id} item={item} />
            ))}
          </div>
