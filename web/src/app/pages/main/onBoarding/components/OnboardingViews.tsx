...
export const QuestionView = ({ question, onYes, onNo, yesLabel = 'Yes', noLabel = 'No' }: QuestionViewProps) => (
...
export const SelectionView = ({ title, options, onSelect, selectedValue }: SelectionViewProps) => (
        ...
        <div className="grid grid-cols-1 gap-3">
            {options.map((option) => (
                <button
                    ...
                    className={`p-4 rounded-xl border-2 transition-all duration-300 flex items-center justify-between group ${selectedValue === option.value
