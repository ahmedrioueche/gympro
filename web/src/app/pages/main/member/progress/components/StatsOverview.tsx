    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
      {statItems.map((item, index) => (
        ...
        >
          ...
          <div
            className={`absolute -right-10 -top-10 h-24 w-24 md:h-32 md:w-32 rounded-full bg-gradient-to-br ${item.color} opacity-10 blur-3xl group-hover:opacity-20 transition-opacity`}
          />

          <div className="flex flex-col gap-3 md:gap-4">
            <div className="flex items-center justify-between">
              <div
                className={`p-2.5 md:p-3 rounded-2xl bg-gradient-to-br ${item.color} text-white shadow-lg shadow-primary/10`}
              >
