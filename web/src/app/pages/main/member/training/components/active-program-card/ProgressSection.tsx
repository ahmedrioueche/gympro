    ...
    <div className="flex flex-col md:flex-row items-end gap-4 bg-background-secondary/30 rounded-xl p-4 border border-border/50">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          title={t("training.page.archive.confirm")}
        >
          <Archive size={20} />
        </button>
        ...
        <button
          ...
          className="group inline-flex items-center justify-center gap-2 rounded-xl px-5 py-2.5 h-[42px] text-sm font-medium text-white bg-primary hover:bg-primary/80 ring-1 ring-blue-500/30 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
        >
          <Calendar size={18} />
