  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 mt-3 rounded-full bg-secondary/20 border border-secondary/30 text-secondary text-xs font-bold uppercase tracking-widest w-fit">
