...
const AnimatedLogo = ({
  ...
  return (
    <div className={`flex items-center justify-center mb-3 ${height} relative ${width}`}>
      {/* Zap Icon with smooth horizontal shift */}
      <div
        className='zap-container animate-zap-move'
        style={{ left: leftPosition }}
      >
        <div className={`${logoSize} bg-gradient-to-br from-primary to-secondary rounded-xl flex items-center justify-center shadow-lg zap-shine`}>
